 ...
 */
public class HttpUploadResponceHandler<T> extends BaseHttpResponceHandler<T> {
    ...
    public HttpUploadResponceHandler() {
        this(false);
    }
     ...
     */
    public HttpUploadResponceHandler(boolean isShowProgress) {
